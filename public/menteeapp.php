...
<div class="col-md-11">        
    <h1>New Mentee Account</h1>
    <p>
        Fill out the form below to sign up for the program as a <em><b>mentee</b></em> only. Required fields are labeled in red.
    </p>
    <hr>
    ...
    <form method="post" action="../actions/addMentee.php" class="form-inline"><fieldset>
        <div class="row">
            <div class="col-md-6">
		...
		<div class="row">
            ...
            <div class="col-md-6">
                <span style="font-size:1.25em; color:red"><b> Password: </b></span><br>
                <input type="password" id="pw" class="form-control required" style="width: 50%" name="pw" />
            </div>
		</div>
        <br>
		<div class="row">  
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p> 
                    Check all situations that you have experience with or would like help with.
                </p>
            </div>
        </div>
        <div class="row">
...
<script type="text/javascript">
    ...
    $( '#fname, #lname, #un, #pw, #year, #age' ).keyup(function(){
        validate();
    });
